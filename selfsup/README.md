...
|---|---|
| `plan.md` | 계획 (P0~P5) |
| `ledger.md` | **실험 장부 전부** — 14개 실험, 9경주 출발 전 예측, 채점기 SE 정정 |
...
| 확정배당을 학습 신호로 — 가짜 배당 생성·스태킹 (P13) | 배당은 train 라벨로만 | 단독 −1.75 · 스태킹 +0.64 [−0.48, +1.75] | 시장의 우위는 과거 패턴으로 복원 안 된다 |
| 당일 앞 경주 신호 — 트랙 편향·기수 오늘 성적 (P14) | 원장만 | −0.24 [−1.28, +0.80] | 공공데이터로 '당일 정보' 흉내 내기 끝 |
